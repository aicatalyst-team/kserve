...
class TestCase:
    ...
    # Factory provided
    llm_service: V1alpha2LLMInferenceService = None  # Generated by llm_service_factory
...
@log_execution
def create_llmisvc(kserve_client: KServeClient, llm_isvc: V1alpha2LLMInferenceService):
    try:
...
def get_llm_service_url(
    kserve_client: KServeClient, llm_isvc: V1alpha2LLMInferenceService
):
